...
public class Balloom extends EnemyEntity {
        ...
        public Balloom(int x, int y, int imageId) {
                ...
                imageIds[UP_MOVING] = new int[] {
                                Sprite.BALLOOM_LEFT_0, Sprite.BALLOOM_LEFT_1, Sprite.BALLOOM_LEFT_2,
                                Sprite.BALLOOM_LEFT_3
                };
                imageIds[DOWN_MOVING] = new int[] {
                                Sprite.BALLOOM_RIGHT_0, Sprite.BALLOOM_RIGHT_1, Sprite.BALLOOM_RIGHT_2,
                                Sprite.BALLOOM_RIGHT_3
                };
                ...
                imageIds[DEAD] = new int[] {
                                Sprite.BALLOOM_DEAD_0, Sprite.BALLOOM_DEAD_1, Sprite.BALLOOM_DEAD_2,
                                Sprite.BALLOOM_DEAD_3,
